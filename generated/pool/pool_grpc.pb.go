...
const (
	PoolService_GetPoolInfo_FullMethodName    = "/pool.PoolService/GetPoolInfo"
	PoolService_GetNetworkInfo_FullMethodName = "/pool.PoolService/GetNetworkInfo"
	PoolService_GetPoolSlaves_FullMethodName  = "/pool.PoolService/GetPoolSlaves"
	PoolService_GetPoolStats_FullMethodName   = "/pool.PoolService/GetPoolStats"
)
...
func (c *poolServiceClient) GetPoolInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PoolInfo, error) {
	...
	out := new(PoolInfo)
	err := c.cc.Invoke(ctx, PoolService_GetPoolInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poolServiceClient) GetNetworkInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NetworkInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NetworkInfo)
	err := c.cc.Invoke(ctx, PoolService_GetNetworkInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poolServiceClient) GetPoolSlaves(ctx context.Context, in *GetPoolAssetRequest, opts ...grpc.CallOption) (*PoolSlaves, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PoolSlaves)
	err := c.cc.Invoke(ctx, PoolService_GetPoolSlaves_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poolServiceClient) GetPoolStats(ctx context.Context, in *GetPoolAssetRequest, opts ...grpc.CallOption) (*PoolStats, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PoolStats)
	err := c.cc.Invoke(ctx, PoolService_GetPoolStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PoolService_GetPoolInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolService_GetPoolInfo_FullMethodName,
	}
...
func _PoolService_GetNetworkInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolService_GetNetworkInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PoolService_GetPoolSlaves_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolService_GetPoolSlaves_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PoolService_GetPoolStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolService_GetPoolStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
