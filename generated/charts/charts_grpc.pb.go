...
const (
	ChartsService_GetPoolStats_FullMethodName            = "/charts.ChartsService/GetPoolStats"
	ChartsService_GetNetworkDifficulties_FullMethodName  = "/charts.ChartsService/GetNetworkDifficulties"
	ChartsService_GetRounds_FullMethodName               = "/charts.ChartsService/GetRounds"
	ChartsService_GetMinerProfitabilities_FullMethodName = "/charts.ChartsService/GetMinerProfitabilities"
	ChartsService_GetMinerHashrates_FullMethodName       = "/charts.ChartsService/GetMinerHashrates"
	ChartsService_GetMinerWorkerHashrates_FullMethodName = "/charts.ChartsService/GetMinerWorkerHashrates"
	ChartsService_GetMinerShares_FullMethodName          = "/charts.ChartsService/GetMinerShares"
	ChartsService_GetMinerWorkerShares_FullMethodName    = "/charts.ChartsService/GetMinerWorkerShares"
)
...
type ChartsServiceClient interface {
	...
	GetNetworkDifficulties(ctx context.Context, in *GetNetworkDifficultiesRequest, opts ...grpc.CallOption) (*NetworkDifficultiesPoints, error)
...
func (c *chartsServiceClient) GetPoolStats(ctx context.Context, in *GetPoolStatsRequest, opts ...grpc.CallOption) (*PoolStatsPoints, error) {
	...
	err := c.cc.Invoke(ctx, ChartsService_GetPoolStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsServiceClient) GetNetworkDifficulties(ctx context.Context, in *GetNetworkDifficultiesRequest, opts ...grpc.CallOption) (*NetworkDifficultiesPoints, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NetworkDifficultiesPoints)
	err := c.cc.Invoke(ctx, ChartsService_GetNetworkDifficulties_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsServiceClient) GetRounds(ctx context.Context, in *GetRoundsRequest, opts ...grpc.CallOption) (*RoundsPoints, error) {
	...
	err := c.cc.Invoke(ctx, ChartsService_GetRounds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsServiceClient) GetMinerProfitabilities(ctx context.Context, in *GetMinerChartRequest, opts ...grpc.CallOption) (*MinerProfitabilitiesPoints, error) {
	...
	err := c.cc.Invoke(ctx, ChartsService_GetMinerProfitabilities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsServiceClient) GetMinerHashrates(ctx context.Context, in *GetMinerChartRequest, opts ...grpc.CallOption) (*MinerHashratesPoints, error) {
	...
	err := c.cc.Invoke(ctx, ChartsService_GetMinerHashrates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsServiceClient) GetMinerWorkerHashrates(ctx context.Context, in *GetMinerWorkerChartRequest, opts ...grpc.CallOption) (*MinerHashratesPoints, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MinerHashratesPoints)
	err := c.cc.Invoke(ctx, ChartsService_GetMinerWorkerHashrates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsServiceClient) GetMinerShares(ctx context.Context, in *GetMinerChartRequest, opts ...grpc.CallOption) (*MinerSharesPoints, error) {
	...
	err := c.cc.Invoke(ctx, ChartsService_GetMinerShares_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsServiceClient) GetMinerWorkerShares(ctx context.Context, in *GetMinerWorkerChartRequest, opts ...grpc.CallOption) (*MinerSharesPoints, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MinerSharesPoints)
	err := c.cc.Invoke(ctx, ChartsService_GetMinerWorkerShares_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChartsServiceServer interface {
	...
	GetNetworkDifficulties(context.Context, *GetNetworkDifficultiesRequest) (*NetworkDifficultiesPoints, error)
...
// UnimplementedChartsServiceServer must be embedded to have
...
func (UnimplementedChartsServiceServer) GetNetworkDifficulties(context.Context, *GetNetworkDifficultiesRequest) (*NetworkDifficultiesPoints, error) {
...
func (UnimplementedChartsServiceServer) testEmbeddedByValue()                       {}
...
func RegisterChartsServiceServer(s grpc.ServiceRegistrar, srv ChartsServiceServer) {
	// If the following call pancis, it indicates UnimplementedChartsServiceServer was
...
func _ChartsService_GetPoolStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChartsService_GetPoolStats_FullMethodName,
	}
...
func _ChartsService_GetNetworkDifficulties_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNetworkDifficultiesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChartsService_GetNetworkDifficulties_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChartsServiceServer).GetNetworkDifficulties(ctx, req.(*GetNetworkDifficultiesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChartsService_GetRounds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChartsService_GetRounds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChartsService_GetMinerProfitabilities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChartsService_GetMinerProfitabilities_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChartsService_GetMinerHashrates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChartsService_GetMinerHashrates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChartsService_GetMinerWorkerHashrates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChartsService_GetMinerWorkerHashrates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChartsService_GetMinerShares_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChartsService_GetMinerShares_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChartsService_GetMinerWorkerShares_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChartsService_GetMinerWorkerShares_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
